...
class Superwar {
  ...
  checkWin = () => {
    ...
    if (scores.villain === 0 && scores.hero === 0) result = "endure";
    if (scores.villain === 0) result = "hero";
    else if (scores.hero === 0) result = "villain";
  ...
  totalStrength = (type) => {
    ...
    let strength = 0;
    play.map((ele) => (strength += ele.strength));
